...
CGameAppDoc::CGameAppDoc() noexcept
{
...
void CGameAppDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CGameAppDoc::InitializeSearchContent()
{
...
void CGameAppDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
